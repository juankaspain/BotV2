// ==================== BotV2 Service Worker v1.1 ====================
// Professional PWA Service Worker with Offline Support
// ✅ NOW AT ROOT: /sw.js (scope='/' allowed)
// Author: Juan Carlos Garcia
// Date: 24-01-2026

const CACHE_VERSION = 'botv2-v1.1';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing Service Worker v1.1 from root...');
...
self.addEventListener('activate', (event) => {
  ...
  event.waitUntil(
    caches.keys()
      ...
      .then(() => {
        console.log('[SW] Service Worker activated with scope: /');
  ...
  if (event.tag === 'sync-data') {
    event.waitUntil(
      fetch('/api/sync')
        ...
        .then(data => console.log('[SW] Sync completed:', data))
...
console.log('[SW] Service Worker v1.1 loaded from root (scope=/)');
